...
'Ввод телефона'
WebUI.setText(findTestObject('Object Repository/Регистрация пациента (Test case)/input_Phone'), '+7 (9)' + RandomStringUtils.randomNumeric(
        9))

'Ввод телефона'
GlobalVariable.Test_phone = WebUI.getAttribute(findTestObject('Регистрация пациента (Test case)/input_Phone'), 'value')
